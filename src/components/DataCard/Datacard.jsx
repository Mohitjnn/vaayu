...
function Datacard({ Reasons }) {
  return (
    <div className="flex flex-col items-center h-full w-full mx-16 py-3 transition-transform duration-300 ease-in-out transform hover:scale-110 overflow-visible">
